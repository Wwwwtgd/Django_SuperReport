...
def auto_edit_ut(book_path, report_type):
    ...
    if report_type == "yz-63-dn":
        first_page = path_all + "A超声现场-扬州-63-东南.docx"  # 第一页模板路径  "A超声现场-扬州.docx"
        res_page = path_all + "A超声检测结果页-扬州.docx"  # 第二页模板路径
    elif report_type == "yz-63-rt":
        first_page = path_all + "A超声现场-扬州-63-润通.docx"  # 第一页模板路径  "A超声现场-扬州.docx"
        res_page = path_all + "A超声检测结果页-扬州.docx"  # 第二页模板路径
    elif report_type == "yz-65-dn":
        first_page = path_all + "A超声现场-扬州-65-东南.docx"  # 第一页模板路径  "A超声现场-扬州.docx"
        res_page = path_all + "A超声检测结果页-扬州.docx"  # 第二页模板路径
    elif report_type == "yz-65-wx":
        first_page = path_all + "A超声现场-扬州-65-纬信.docx"  # 第一页模板路径  "A超声现场-扬州.docx"
        res_page = path_all + "A超声检测结果页-扬州.docx"  # 第二页模板路径
    elif report_type == "sz":
